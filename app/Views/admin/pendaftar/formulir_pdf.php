...
<head>
    ...
    <!-- General CSS Files -->
    <!-- <link rel="stylesheet" type="text/css" href="<?= base_url('/assets/modules/bootstrap/css/bootstrap.min.css') ?>"> -->
...
<body>
    <table>
        ...
        <!-- <td><img src="<?= base_url() ?>/<?= $setting['logo'] ?>" width="80" /></td> -->
    ...
    <div class="table-responsiv">
        <table style="font-size: 12px" class="table table-bordered table-sm ">
            <tbody>
                <tr>
                    <td align="center" width="110"><b>FOTO SISWA</b></td>
                ...
                <tr>
                    ...
                    <td width="90"><b>NISN</b></td>
                    <td><?= $siswa['nisn'] ?></td>
                </tr>

                <tr>
                    <td><b>Nama Lengkap</b></td>
                    <td align="left"><?= ucfirst($siswa['nama_lengkap']) ?></td>
                </tr>
                <tr>
                    <td><b>Tempat Tgl Lahir</b></td>
                    <td align="left"><?= ucfirst($siswa['tempat_lahir']) ?> <?= $siswa['tgl_lahir'] ?></td>
                </tr>
                <tr>
            ...
            <tbody>
                <tr>
                    <?php if ($setting['jurusan'] == 1) { ?>
                        ...
                        <td align="left"><?= ucfirst($siswa['jurusan'])  ?></td>
                    <?php } ?>
                ...
                <tr>
                    ...
                    <td align="left"><?= strtoupper($siswa['asal_sekolah'])  ?></td>
                    <td><b>Tinggi Badan (Cm)</b></td>
                    <td align="left"><?= $siswa['tinggi']  ?></td>
                </tr>
                <tr>
                    <td><b>Alamat Siswa</b></td>
                    <td align="left"><?= ucfirst($siswa['alamat'])  ?></td>
                ...
                <tr>
                    <td><b>Desa</b></td>
                    <td align="left"><?= ucfirst($siswa['desa'])  ?></td>
                    <td><b>Status Dalam Keluarga</b></td>
                    <td align="left"><?= $siswa['status_keluarga']  ?></td>
                </tr>
                <tr>
                    <td><b>Kecamatan</b></td>
                    <td align="left"><?= ucfirst($siswa['kecamatan'])  ?></td>
                    <td><b>Tinggal Bersama</b></td>
                    <td align="left"><?= ucfirst($siswa['tinggal'])  ?></td>
                </tr>
                <tr>
                    <td><b>Kota / Kabupaten</b></td>
                    <td align="left"><?= ucfirst($siswa['kota'])  ?></td>
                    <td><b>Jarak KeSekolah (Meter)</b></td>
                    <td align="left"><?= $siswa['jarak']  ?></td>
                </tr>
                <tr>
                    <td><b>Provinsi</b></td>
                    <td align="left"><?= ucfirst($siswa['provinsi'])  ?></td>
        ...
        <table style="font-size: 12px" class="table table-bordered  table-sm ">
            <tbody>
                ...
                <tr>
                    <td><b>Nama Lengkap</b></td>
                    <td align="left"><?= ucfirst($siswa['nama_ayah']) ?></td>
                    <td align="left"><?= ucfirst($siswa['nama_ibu']) ?></td>
                    <td align="left"><?= ucfirst($siswa['nama_wali']) ?></td>
                </tr>
                <tr>
                    <td><b>Tempat Tgl Lahir</b></td>
                    <td align="left"><?= ucfirst($siswa['tempat_ayah']) ?> <?= $siswa['tgl_lahir_ayah'] ?></td>
                    <td align="left"><?= ucfirst($siswa['tempat_ibu']) ?> <?= $siswa['tgl_lahir_ibu'] ?></td>
                    <td align="left"><?= ucfirst($siswa['tempat_wali']) ?> <?= $siswa['tgl_lahir_wali'] ?></td>
                </tr>
                <tr>
                    <td><b>Pendidikan</b></td>
                    <td align="left"><?= strtoupper($siswa['pendidikan_ayah'])  ?></td>
                    <td align="left"><?= strtoupper($siswa['pendidikan_ibu'])  ?></td>
                    <td align="left"><?= strtoupper($siswa['pendidikan_wali'])  ?></td>
                </tr>
                <tr>
                    <td><b>Pekerjaan</b></td>
